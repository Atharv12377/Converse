...
export const ChatLayout = () => {
  return (
    <div className="h-screen w-full min-w-md bg-red-50 flex flex-col">
      <div className="h-20 bg-indigo-400 p-3 flex justify-center items-center">
        <Navbar />
      </div>
      ...
      <div className="h-full flex flex-1 w-full bg-red-50">

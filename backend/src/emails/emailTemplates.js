export function createVerificationEmailTemplate(name, verificationURL) {
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
    ...
    <div style="background-color: #ffffff; padding: 35px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
      ...
      <p>Thanks for signing up for Converse! Before you can start chatting, please verify your email address.</p>

      <p style="margin-top: 10px;">Click the button below to verify your account:</p>
      ...
      <p>This verification link is valid for <strong>1 hour</strong>.</p>

      <p style="margin-top: 20px;">If you did not create this account, you can safely ignore this email.</p>

      <p style="margin-top: 25px; margin-bottom: 0;">Best regards,<br />The Converse Team</p>
    </div>

    <div style="text-align: center; padding: 20px; color: #999; font-size: 12px;">
      <p>© 2025 Converse. All rights reserved.</p>
      <p>
